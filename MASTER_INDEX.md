...
**🎯 Próxima tarea real, sin esperar instrucción**: audio espacial básico con `PannerNode` (P1.5 del backlog, el último punto de la prioridad P1) — hoy un disparo suena igual sin importar la distancia/posición respecto a la cámara.
