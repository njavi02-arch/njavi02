...
**🎯 Próxima tarea real, sin esperar instrucción**: VFX de disparo/impacto diferenciado por categoría (P1.3 del backlog) — hoy `spawnMuzzleFlash()` es una única función compartida por las 68 armas.
