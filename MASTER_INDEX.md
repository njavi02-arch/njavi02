...
|---|---|---|---|---|---|---|
| BACKLOT-7 | 🟢 blockout | 🟢 propia | 🟢 propio (viento abierto, filtro 550Hz) | 🟢 PBR real (hormigón/ladrillo/madera/metal, ver PROGRESS) | 🔴 no existen | 🔴 sin LOD/oclusión |
...
**Resto de la directiva P0 (edificios/paredes/colisiones/balística), lo único que queda abierto**: interiores reales en edificios accesibles, priorizando los ya "jugables" de cada mapa (Control Tower/Warehouse/Office en KRYPTOS-URBAN, estructuras de fábrica en INDUSTRIAL-5) — balística, colisión jugador-vs-pared, y materiales/PBR ya están resueltos y verificados en los 4 mapas.
