...
**Resto de la directiva P0 (edificios/paredes/colisiones/balística), sigue abierto** — la balística era la pieza más urgente y ya está resuelta y verificada; queda: (1) extender los 6 materiales PBR de KRYPTOS-URBAN a BACKLOT-7/INDUSTRIAL-5/OUTPOST-9 (hoy solo KRYPTOS-URBAN tiene PBR real, el resto sigue en color plano); (2) interiores reales en edificios accesibles, priorizando los ya "jugables" de cada mapa (Control Tower/Warehouse/Office en KRYPTOS-URBAN, estructuras de fábrica en INDUSTRIAL-5); (3) auditoría explícita de colisiones jugador-vs-pared/puerta/vehículo en los 4 mapas (la balística ya respeta la geometría etiquetada, pero el movimiento del jugador contra esa misma geometría no se ha auditado aparte todavía en esta tanda).
